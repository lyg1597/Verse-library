...
if __name__ == "__main__":
    ...
    for j in range(20):
        ...
        P = np.random.uniform(0,2,(3,1))
        P0 = (P[0,0],P[1,0],P[2,0])
        p1 = []
        p2 = []
        p3 = []
        Q = np.eye(3)
        ...
        for i in range(50000):
            ...
            DC1 = 2*xtf.T@expm(A1.T*P[0])@A1.T@expm(A2.T*P[1])@expm(A3.T*P[2])@Q@xtf
            DC2 = 2*xtf.T@expm(A1.T*P[0])@expm(A2.T*P[1])@A2.T@expm(A3.T*P[2])@Q@xtf
            DC3 = 2*xtf.T@expm(A1.T*P[0])@expm(A2.T*P[1])@expm(A3.T*P[2])@A3.T@Q@xtf
